 ...
 */
define(["require", "exports", "N/log", "N/error", "N/http", "../Controllers/FischerCallVolumeByMonthController"], function (require, exports, log, error, http, controller) {
    ...
    function handleGet(pContext) {
        ...
        var dataJSON = controller.getReportData(pContext.request.headers);
        pContext.response.writeLine({ output: JSON.stringify(dataJSON) });
    }
