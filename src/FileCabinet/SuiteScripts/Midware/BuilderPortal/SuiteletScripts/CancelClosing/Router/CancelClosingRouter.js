 ...
 */
define(["require", "exports", "N/log", "N/error", "N/http", "../Controllers/CancelClosingController"], function (require, exports, log, error, http, controller) {
    ...
    function handleGet(pContext) {
        pContext.response.write({ output: controller.getCancelClosing(pContext.request.parameters) });
    }
    function handlePost(pContext) {
        pContext.response.write({ output: controller.proccessCancelClosing(pContext.request.parameters) });
    }
