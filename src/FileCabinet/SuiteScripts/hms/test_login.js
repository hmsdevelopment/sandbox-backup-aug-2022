...
//	 var custpage_builder_personnel = form.addField('custpage_builder_personnel', 'select', 'If someone else is in charge of building permits slect them here');
...
//	  }
      ...
      form.addResetButton();
      form.setScript('customscript_login_css');
      response.writePage(form);
      
//      var html = '<html>' 
//      + '<head>'
//      + '<link rel="stylesheet" type="text/css" ' 
//      + 'href="https://1309901.app.netsuite.com/core/media/media.nl?id=30060&c=1309901&h=c1affd8dda9387b99fb8&_xt=.css">' //Place URL from .css/.js file(in file cabinet) here. 
//      + '</head>' 
//      + '<body>something:'
//      + 'something' 
//      + '<br/>' 
//      + '<form method="post">Input <input type="text" '
//      + 'name="something" id="something" value=""/>' 
//      + ' <input type="submit"/>'
//      + '</form>'
//      + '</body>' + '</html>'; 
//      response.write(html);
   ...
   else
   {
	...
	//Create the Floorplan, if entered
		  ...
		  var redirectURL = nlapiResolveURL('SUITELET','customscript221','customdeploy1',true)+"&partnerid=" + userID + "&builderid=" + builderDivisionID + "&propertyid=" + propertyRecordID;
