...
function uploader(request, response)
{
   if (request.getMethod() == 'GET')
   {
	  ...
	  var closingNotes = form.addField('custpage_cn_seller_paid_closing_costs', 'currency', 'Seller Paid Closing Costs');
	  var closingNotes = form.addField('custpage_cn_concessions', 'textarea', 'Concessions');
   ...
   else
   {
	  ...
	  var sellerPaidClosingCosts = request.getParameter("custpage_cn_seller_paid_closing_costs");
	  var concessions = request.getParameter("custpage_cn_concessions");
	  ...
	  propertyRecord.setFieldValue('custrecord_seller_paid_closing_costs', sellerPaidClosingCosts);
	  propertyRecord.setFieldValue('custrecord_concessions', concessions);
      ...
      var recipient = nlapiGetContext().getSetting('SCRIPT', 'custscript_cn_submission_notification_co');
